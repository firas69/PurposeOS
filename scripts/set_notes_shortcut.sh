#!/usr/bin/env bash
# set_notes_shortcut.sh — Register Ctrl+Shift+P as a GNOME keyboard shortcut
# that opens the PurposeOS Notes window from anywhere on the desktop.
...
BINDING="${1:-<Primary><Shift>p}"
NAME="PurposeOS Notes"
COMMAND="${ADCTL_PATH} quicknote"
